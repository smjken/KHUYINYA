...
questions_list.append(Question('В каком году произошел взрыв на на Чернобыльской станции ЧАЭС?', '1991', '1979', '1986', '1983'))
questions_list.append(Question('Как звали женщину которая прожила 122 года?', 'Барто', 'Кальман', 'Терешкова', 'Монро'))
questions_list.append(Question('Какие 2 страны имеют водную границу с Россией?', 'США и Япония', 'Китай и Сев.Корея', 'Франция и А', 'Швеция и Норвегия'))
questions_list.append(Question('Какую площадь территории имеет  Россия?', '17,1кв.км.', '15.6кв.км', '11.3кв.км', '20кв.км'))
questions_list.append(Question('Какой известный онлайн-шутер был сделан в США?', 'CS:GO', 'NFS', 'FAR CRY', 'DETROIT'))
questions_list.append(Question('В каком году умер Борис Клюев?', '2020', '2011', '2021', '2018'))
questions_list.append(Question('В каком году появился футбол?', '1863', '1822', '1912', '1799'))
